...
export default function ProjectForm(){
  ...
  const handleClearFile = e => {
    setProject({...project, imageUrl: '', imageFile: ''})
    ...
    if(page === 1){
      ...
      return(
        <>
          ...
          <div className='project-errors'>{renderErrors()}</div>
          <div className='new-project-buttons'>
            <button className='new-project-back-button' onClick={()=> setPage(1)}><span className='arrow-icon'><CgArrowLongLeft /></span> Back: Project Category</button>
        ...
        <>
          ...
          <div className="input-container">
              <textarea 
                ...
                className="project-field"
              />
              <label id={project?.campaign && 'filled'}>Campaign: What is the story and risks associated?</label>
          </div>
          <div className="input-container">
            <textarea
              type="text"
              ...
              className="project-field"
            />
            <label id={project?.updates && 'filled'}>Updates: Anything you would like to share?</label>
          </div>
          <div className="input-container">
            <textarea
              type="text"
              ...
              className="project-field"
            />
            <label id={project?.faq && 'filled'}>Frequently Asked Questions</label>
          </div>
          <div className='project-errors'>{renderErrors()}</div>
          <div className='new-project-buttons'>
            <button className='new-project-back-button' onClick={()=> setPage(2)}><span className='arrow-icon'><CgArrowLongLeft /></span> Back: Project Title</button>
        ...
        <>
          ...
          <div className="input-container">
            <input
              ...
              className="project-field"
            />
            <label id={project?.location && 'filled'}>Location</label>
          </div>  
          <div className='project-errors'>{renderErrors()}</div>
          <div className='new-project-buttons'>
            <button className='new-project-back-button' onClick={()=> setPage(3)}><span className='arrow-icon'><CgArrowLongLeft /></span> Back: Campaign Details</button>
        ...
        <>
          ...
          <div className="input-container">
            <input required
              ...
              className="project-field"
            />
            <label id={project?.funding_goal && 'filled'}>Funding Goal</label>
          </div>
      ...
      return(
        <>
          ...
          {/* </label> */}
          { project.imageUrl ? <button onClick={handleClearFile}>Remove</button>: null}

          <div className='project-errors'>{renderErrors()}</div>
          <div className='new-project-buttons'>
            <button className='new-project-back-button' onClick={()=> setPage(5)}><span className='arrow-icon'><CgArrowLongLeft /></span> Back: Project Dates and Goal</button>
